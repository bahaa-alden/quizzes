...
class QuestionRoutes {
    ...
    routes() {
        ...
        // CREATE QUESTION
        this.router.post('/', (0, restrict_1.default)(ADMIN), authorization_1.authorizationMiddleware.authorization, (0, validator_1.default)({ body: question_schema_1.default.questionCreate }), question_controller_1.questionController.createQuestion);
        ...
        this.router.delete('/:id', (0, restrict_1.default)(ADMIN), authorization_1.authorizationMiddleware.authorization, (0, validator_1.default)({ params: question_schema_1.default.questionId }), question_controller_1.questionController.deleteQuestion);
    }
}
