...
class SessionRoutes {
    ...
    routes() {
        ...
        // GET ALL SESSIONS
        this.router.get('/', (0, restrict_1.default)(USER, ADMIN), authorization_1.authorizationMiddleware.authorization, (0, validator_1.default)({ query: session_schema_1.default.sessionAll }), session_controller_1.sessionController.getSessions);
        // GET ALL SESSIONS
        ...
        // GET SESSION BY ID
        this.router.get('/:id', (0, restrict_1.default)(USER, ADMIN), authorization_1.authorizationMiddleware.authorization, (0, validator_1.default)({ params: session_schema_1.default.sessionId }), session_controller_1.sessionController.getSession);
        // CREATE SESSION
        ...
        this.router.delete('/:id', (0, restrict_1.default)(ADMIN), authorization_1.authorizationMiddleware.authorization, (0, validator_1.default)({ params: session_schema_1.default.sessionId }), session_controller_1.sessionController.deleteSession);
    }
}
